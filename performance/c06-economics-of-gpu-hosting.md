# Performance — The Economic Reality of GPU Hosting: Dollars-per-Hour vs Dollars-per-Token

**Slug:** `c06-economics-of-gpu-hosting`
**Batch:** parallel-20 (concepts)
**Started:** 2026-05-20T17:42:39
**Finished:** 2026-05-20T17:45:21
...
| Wall time (s) | 161.98 |
| Prompt tokens | 896 |
| Output tokens (eval_count) | 6107 |
| Output words | 3216 |
| Output characters | 20264 |
| Tokens / second (per-request, shared GPU) | 37.7 |
| Words / token (efficiency) | 0.527 |

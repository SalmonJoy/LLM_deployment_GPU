# Performance — Measure Before You Optimize: The First-Hour Rule for Inherited Systems

**Slug:** `c09-measure-before-optimize`
**Batch:** parallel-20 (concepts)
**Started:** 2026-05-20T17:42:39
**Finished:** 2026-05-20T17:45:54
...
| Wall time (s) | 194.93 |
| Prompt tokens | 828 |
| Output tokens (eval_count) | 5916 |
| Output words | 3178 |
| Output characters | 20845 |
| Tokens / second (per-request, shared GPU) | 30.3 |
| Words / token (efficiency) | 0.537 |

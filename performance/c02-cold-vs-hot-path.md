# Performance — Cold-Path vs Hot-Path Optimization in LLM Serving

**Slug:** `c02-cold-vs-hot-path`
**Batch:** parallel-20 (concepts)
**Started:** 2026-05-20T17:42:39
**Finished:** 2026-05-20T17:45:02
...
| Wall time (s) | 143.65 |
| Prompt tokens | 793 |
| Output tokens (eval_count) | 7133 |
| Output words | 3905 |
| Output characters | 24925 |
| Tokens / second (per-request, shared GPU) | 49.7 |
| Words / token (efficiency) | 0.547 |

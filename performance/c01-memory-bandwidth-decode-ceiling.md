# Performance — Memory Bandwidth: The Real Speed Limit of LLM Decode

**Slug:** `c01-memory-bandwidth-decode-ceiling`
**Batch:** parallel-20 (concepts)
**Started:** 2026-05-20T17:42:39
**Finished:** 2026-05-20T17:45:53
...
| Wall time (s) | 194.60 |
| Prompt tokens | 858 |
| Output tokens (eval_count) | 6333 |
| Output words | 3302 |
| Output characters | 21696 |
| Tokens / second (per-request, shared GPU) | 32.5 |

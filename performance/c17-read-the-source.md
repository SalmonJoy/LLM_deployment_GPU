# Performance — Reading the Source: Diagnostics When Configs Are Opaque

**Slug:** `c17-read-the-source`
**Batch:** parallel-20 (concepts)
**Started:** 2026-05-20T17:42:39
**Finished:** 2026-05-20T17:44:58
...
| Wall time (s) | 139.72 |
| Prompt tokens | 906 |
| Output tokens (eval_count) | 6956 |
| Output words | 3896 |
| Output characters | 25643 |
| Tokens / second (per-request, shared GPU) | 49.8 |
| Words / token (efficiency) | 0.560 |

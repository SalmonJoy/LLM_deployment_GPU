# Performance — Quantization in Practice: When Lower Precision Is Free, and When It Costs You

**Slug:** `c05-quantization-in-practice`
**Batch:** parallel-20 (concepts)
**Started:** 2026-05-20T17:42:39
**Finished:** 2026-05-20T17:45:07
...
| Wall time (s) | 147.83 |
| Prompt tokens | 854 |
| Output tokens (eval_count) | 7353 |
| Output words | 3898 |
| Output characters | 25526 |
| Tokens / second (per-request, shared GPU) | 49.7 |
| Words / token (efficiency) | 0.530 |

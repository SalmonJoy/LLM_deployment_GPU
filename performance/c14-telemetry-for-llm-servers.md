# Performance — Telemetry for LLM Servers: What to Watch and Why

**Slug:** `c14-telemetry-for-llm-servers`
**Batch:** parallel-20 (concepts)
**Started:** 2026-05-20T17:42:39
**Finished:** 2026-05-20T17:45:08
...
| Wall time (s) | 148.89 |
| Prompt tokens | 920 |
| Output tokens (eval_count) | 7409 |
| Output words | 3777 |
| Output characters | 26003 |
| Tokens / second (per-request, shared GPU) | 49.8 |
| Words / token (efficiency) | 0.510 |
